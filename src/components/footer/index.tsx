...
const productLinks = [`Funcionalidades`, `Clientes`, `Plataforma`, `Precio`, `Compañia`];
const resourceLinks = [
  `Empieza`,
  `Guías`,
  `Herramientas`,
  ...
  <footer className={tw(`bg-white border-t border-gray-400 pt-14 pb-16`)}>
    <div className={tw(`max-w-7xl mx-auto text-gray-400 px-8 lg:px-0 flex flex-wrap`)}>
      <div className={tw(`mb-14 flex items-center w-full`)}>
        ...
        <p className={tw(`text-4xl text-indigo-500 font-bold`)}>GABO</p>
      </div>
      ...
      <div className={tw(`w-full lg:w-1/2 mt-12 lg:mt-0`)}>
        <div className={tw(`border border-gray-400 rounded py-5 px-4`)}>
          <h4 className={tw(`font-mono text-sm uppercase text-gray-500 mb-3`)}>Suscríbete a nuestra lista de correo</h4>
